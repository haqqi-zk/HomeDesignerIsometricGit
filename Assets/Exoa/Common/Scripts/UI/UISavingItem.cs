...
namespace Exoa.Designer
{
    public class UISavingItem : MonoBehaviour
    {
        ...
        public void Edit(string fileName, string newName)
        {
            ...
            {
                SaveSystem.Create(SaveSystem.Mode.ONLINE).RenameFileItem(fileName, newName, SaveSystem.defaultSubFolderName, () =>
                {
                    //Debug.Log("Renamed save file complete!");
                    // Now renaming the thumbnail
                    SaveSystem.Create(SaveSystem.Mode.ONLINE).RenameFileItem(thumbnailPrefix + "_" + fileName.Replace("json", "png"), thumbnailPrefix + "_" + newName.Replace("json", "png"), HDSettings.EXTERIOR_WALL_MATERIALS_FOLDER, () =>
                    {
        ...
        public void Delete(string fileName)
        {
            ...
            if (_DatabaseController.connectionState)
            {
                SaveSystem.Create(SaveSystem.Mode.ONLINE).DeleteFileItem(fileName, SaveSystem.defaultSubFolderName, () =>
                {
